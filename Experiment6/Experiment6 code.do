...
import delimited "Experiment6/Experiment6 raw.csv", varnames(1) case(preserve) clear
...
// pruning data set
keep id cond trial scenario incongruent age gender dv l1 l2
order id cond trial scenario incongruent age gender dv l1 l2
...
// saving data
snapshot save
save "meta-analysis/Experiment6.dta", replace
export delimited "Experiment6/Experiment6 clean.csv", replace
