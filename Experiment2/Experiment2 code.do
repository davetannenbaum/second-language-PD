...
import delimited "Experiment2/Experiment2 raw.csv", varnames(1) case(preserve) clear
...
gen crt4 = inlist(answerCRT4,"2.25","laensaladacuesta$2.25","laensaladacuesta$2.25.","laensaladacuesta2.25ylasopacuesta3.25","sopa=3.25/ensalada=2.25")
gen crt5 = inlist(answerCRT5,"5","5horas","5horas/", "5hours","a5horas,porqueduplicacadahora.","cincohoras","cincohoras.","hora5")
revrs IRI_2, replace
revrs IRI_5, replace
revrs IRI_6, replace
...
// pruning data set
keep id cond trial scenario incongruent dv IRI NFC CRT age gender l1 l2
order id cond trial scenario incongruent dv IRI NFC CRT age gender l1 l2
...
// saving data
snapshot save
save "meta-analysis/Experiment2.dta", replace
export delimited "Experiment2/Experiment2 clean.csv", replace
...
recode cells (1 2 3 = 1) (4 = -3), gen(contrast1) // blunted Deontology
recode cells (1 2 4 = -1) (3 = 3), gen(contrast2) // heightened Utilitariansim
