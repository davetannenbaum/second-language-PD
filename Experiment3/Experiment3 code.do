...
import delimited "Experiment3/Experiment3 raw.csv", varnames(1) case(preserve) clear
...
// saving data
snapshot save
save "meta-analysis/Experiment3.dta", replace
export delimited "Experiment3/Experiment3 clean.csv", replace
